...
class TheTransitionPage<T> extends Page<T> {
  /// Constructor for a page with custom transition functionality.
  const TheTransitionPage({
    required this.child,
  ...
  Route<T> createRoute(BuildContext context) {
    return _TheTransitionPageRoute<T>(this);
  }
}

class _TheTransitionPageRoute<T> extends PageRoute<T> {
  _TheTransitionPageRoute(TheTransitionPage<T> page) : super(settings: page);

  TheTransitionPage<T> get _page => settings as TheTransitionPage<T>;
...
class NoTransitionPage<T> extends TheTransitionPage<T> {
