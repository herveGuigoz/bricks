...
abstract class $RegisterStateCopyWith<$Res> {
  ...
  $Res call({FormzStatus status, Email email, Password password, Terms terms});
}
...
class _$_RegisterState with DiagnosticableTreeMixin implements _RegisterState {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'RegisterState(status: $status, email: $email, password: $password, terms: $terms)';
  }
...
abstract class _RegisterState implements RegisterState {
  const factory _RegisterState(
      ...
      final Email email,
      final Password password,
      final Terms terms}) = _$_RegisterState;
